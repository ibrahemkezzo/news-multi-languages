 ...
 * @license MIT
 ...
 <head>
    ...
    <title>{{ $setting->translate(app()->getlocale())->title }}</title>
     ...
     <link href="{{asset('dashboardfiles/dest/style.css')}}" rel="stylesheet">
 </head>
 ...
 <body class="navbar-fixed sidebar-nav fixed-nav">
   ...
   @include('dashboard.layouts.sidbar')
             ...
             <div class="tab-pane active" id="timeline" role="tabpanel">
                 ...
                 <div class="callout callout-warning m-a-0 p-y-1">
                     <div class="avatar pull-xs-right">
                         <img src="{{asset('dashboardfiles/img/avatars/7.jpg')}}" class="img-avatar" alt="admin@bootstrapmaster.com">
                     </div>
                     <div>Meeting with
                         <strong>Lucas</strong>
                     </div>
                 ...
                 <div class="callout callout-info m-a-0 p-y-1">
                     <div class="avatar pull-xs-right">
                         <img src="{{asset('dashboardfiles/img/avatars/4.jpg')}}" class="img-avatar" alt="admin@bootstrapmaster.com">
                     </div>
                     <div>Skype with
                         <strong>Megan</strong>
                     </div>
                 ...
                 <div class="callout callout-danger m-a-0 p-y-1">
                     ...
                     <div class="avatars-stack m-t-h">
                         <div class="avatar avatar-xs">
                             <img src="{{asset('dashboardfiles/img/avatars/2.jpg')}}" class="img-avatar" alt="admin@bootstrapmaster.com">
                         </div>
                         <div class="avatar avatar-xs">
                             <img src="{{asset('dashboardfiles/img/avatars/3.jpg')}}" class="img-avatar" alt="admin@bootstrapmaster.com">
                         </div>
                         <div class="avatar avatar-xs">
                             <img src="{{asset('dashboardfiles/img/avatars/4.jpg')}}" class="img-avatar" alt="admin@bootstrapmaster.com">
                         </div>
                         <div class="avatar avatar-xs">
                             <img src="{{asset('dashboardfiles/img/avatars/5.jpg')}}" class="img-avatar" alt="admin@bootstrapmaster.com">
                         </div>
                         <div class="avatar avatar-xs">
                             <img src="{{asset('dashboardfiles/img/avatars/6.jpg')}}" class="img-avatar" alt="admin@bootstrapmaster.com">
                         </div>
                 ...
                 <div class="callout callout-primary m-a-0 p-y-1">
                     ...
                     <div class="avatars-stack m-t-h">
                         ...
                         <div class="avatar avatar-xs">
                             <img src="{{asset('dashboardfiles/img/avatars/8.jpg')}}" class="img-avatar" alt="admin@bootstrapmaster.com">
                         </div>
                     </div>
                 </div>
                 <hr class="m-x-1 m-y-0">
     ...
     <script src="{{asset('dashboardfiles/js/libs/jquery.min.js')}}"></script>
     <script src="{{asset('dashboardfiles/js/libs/tether.min.js')}}"></script>
     <script src="{{asset('dashboardfiles/js/libs/bootstrap.min.js')}}"></script>
     <script src="{{asset('dashboardfiles/js/libs/pace.min.js')}}"></script>

     <!-- Plugins and scripts required by all views -->
     <script src="{{asset('dashboardfiles/js/libs/Chart.min.js')}}"></script>
